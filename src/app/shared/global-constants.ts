...
export class GlobalConstants {
    ...
    public static instagramURL: string = 'https://www.instagram.com/midwest.mackey?igsh=YnJub2R1M3h0cHVo&utm_source=qr';
    ...
    public static uxDesignLanguageVersion: string = 'HEDWIG';
    // public static uxBootstrapVersion: string = 'v'+pkgBootstrap.version;
    public static CustomBootstrapVersion: string = 'v4.0.0';
}
